...
| Aplicación | URL |
|---|---|
| Admin Panel (Angular) | https://gestion-cursos-admin.vercel.app |
| Catálogo Público (Next.js) | https://gestion-cursos-catalogo.vercel.app |
| Portal Estudiante (React) | https://gestion-cursos-estudiante.vercel.app |
